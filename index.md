...
venue: "Introduction to HPC, Bash and Git <br><br>Griffith University <br> Nathan Campus N78_1.19 "        # brief name of host site without address (e.g., "Euphoric State University")
...
<p id="where">
  <strong>Where:</strong>
<a href="https://www.griffith.edu.au/about-griffith/campuses-facilities" target="_blank">See Campus Maps here</a>
</p>
